#!/usr/bin/env python3
"""
Recuperation des codes promo Direct Assurance depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/direct-assurance.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/direct-assurance.fr"
STORE_NAME = "Direct Assurance"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Direct Assurance depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-direct-assurance)"
    }
    try:
